...
namespace HasznaltAutoKliens
{
    ...
    public partial class PopupWindow_CreateCar : Window
    {
        ...
        public PopupWindow_CreateCar(string sessionId, HasznaltAutoClient hasznaltAutoClient)
        {
            InitializeComponent();
        ...
        public async void Create(object sender, EventArgs e)
        {
            ...
            var response = await _hasznaltAutoClient.CreateCarAsync(new CreateCarRequest
            {
                Car = Car,
